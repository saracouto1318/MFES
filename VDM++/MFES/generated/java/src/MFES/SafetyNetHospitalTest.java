...
public class SafetyNetHospitalTest {
  ...
  private Types.Date date7 = new Types.Date(2017L, 11L, 25L, time7);
  private Types.Time time8 = new Types.Time(12L, 30L);
  private Types.Date date8 = new Types.Date(2017L, 11L, 25L, time8);
  ...
  private Training training2 = new Training(((Object) purpose), schedule2, doctor2);
  ...
  public void testAddRemoveMedHospital() {
    ...
    newTraining = new Training(MFES.quotes.TrainingQuote.getInstance(), schedule4, doctor);
    ...
    assertTrue(
        Utils.equals(
            hospital.getMedicalAssociatedByType(MFES.quotes.DoctorQuote.getInstance()).size(), 0L));
    assertTrue(
        Utils.equals(
    ...
    assertTrue(
        Utils.equals(
            hospital.getMedicalAssociatedByType(MFES.quotes.NurseQuote.getInstance()).size(), 0L));
    assertTrue(
        Utils.equals(
  ...
  public void testOverlap() {
    ...
    assertTrue(Utils.equals(hospital.overlap(schedule, schedule3), false));
  }
  ...
  public void testGetMedMoreHospitals() {
    ...
    for (Iterator iterator_19 = safetyNet.getHospitals().iterator(); iterator_19.hasNext(); ) {
      Hospital t = (Hospital) iterator_19.next();
  ...
  public void testGetMedAssociatedByPatient() {
    ...
    assertTrue(Utils.equals(((VDMSet) Utils.get(mapTest, hospital)), SetUtil.set(doctor)));
  }
