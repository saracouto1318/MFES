...
\hline
\hline
\hyperref[assertTrue:60]{assertTrue} & 60&100.0\% & 169 \\
\hline
\hyperref[main:285]{main} & 285&100.0\% & 2 \\
\hline
\hyperref[testAddRemoveHospitals:64]{testAddRemoveHospitals} & 64&100.0\% & 9 \\
\hline
\hyperref[testAddRemoveMedHospital:95]{testAddRemoveMedHospital} & 95&100.0\% & 6 \\
\hline
\hyperref[testAddRemoveTaskHospital:177]{testAddRemoveTaskHospital} & 177&100.0\% & 11 \\
\hline
\hyperref[testAddRemoveTrainingHospital:215]{testAddRemoveTrainingHospital} & 215&100.0\% & 2 \\
\hline
\hyperref[testGetHospitalsMoreAppointments:238]{testGetHospitalsMoreAppointments} & 238&100.0\% & 2 \\
\hline
\hyperref[testGetMedAssociatedByPatient:260]{testGetMedAssociatedByPatient} & 260&100.0\% & 4 \\
\hline
\hyperref[testGetMedByHospital:270]{testGetMedByHospital} & 270&100.0\% & 2 \\
\hline
\hyperref[testGetMedMoreHospitals:247]{testGetMedMoreHospitals} & 247&100.0\% & 2 \\
\hline
\hline
