...
(*@
\label{testAddRemoveTrainingHospital:220}
@*)
...
(*@
\label{testGetHospitalsMoreAppointments:245}
@*)
...
(*@
\label{testGetMedMoreHospitals:254}
@*)
...
(*@
\label{testGetMedAssociatedByPatient:267}
@*)
...
(*@
\label{testGetMedByHospital:277}
@*)
...
\hline
\hline
\hyperref[assertTrue:60]{assertTrue} & 60&100.0\% & 176 \\
\hline
\hyperref[main:292]{main} & 292&100.0\% & 2 \\
\hline
...
\hline
\hyperref[testAddRemoveTaskHospital:177]{testAddRemoveTaskHospital} & 177&100.0\% & 2 \\
\hline
\hyperref[testAddRemoveTrainingHospital:220]{testAddRemoveTrainingHospital} & 220&100.0\% & 2 \\
\hline
\hyperref[testGetHospitalsMoreAppointments:245]{testGetHospitalsMoreAppointments} & 245&100.0\% & 2 \\
\hline
\hyperref[testGetMedAssociatedByPatient:267]{testGetMedAssociatedByPatient} & 267&100.0\% & 2 \\
\hline
\hyperref[testGetMedByHospital:277]{testGetMedByHospital} & 277&100.0\% & 2 \\
\hline
\hyperref[testGetMedMoreHospitals:254]{testGetMedMoreHospitals} & 254&100.0\% & 2 \\
\hline
\hline
SafetyNetHospitalTest.vdmpp & & 100.0\% & 198 \\
\hline
\end{longtable}
