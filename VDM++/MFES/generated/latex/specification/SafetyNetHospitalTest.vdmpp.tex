...
\hline
\hline
\hyperref[assertTrue:60]{assertTrue} & 60&100.0\% & 47 \\
\hline
\hyperref[main:301]{main} & 301&100.0\% & 1 \\
\hline
\hyperref[testAddRemoveHospitals:64]{testAddRemoveHospitals} & 64&100.0\% & 1 \\
\hline
\hyperref[testAddRemoveMedHospital:95]{testAddRemoveMedHospital} & 95&100.0\% & 1 \\
\hline
\hyperref[testAddRemoveTaskHospital:185]{testAddRemoveTaskHospital} & 185&100.0\% & 1 \\
\hline
\hyperref[testAddRemoveTrainingHospital:229]{testAddRemoveTrainingHospital} & 229&100.0\% & 1 \\
\hline
\hyperref[testGetHospitalsMoreAppointments:254]{testGetHospitalsMoreAppointments} & 254&100.0\% & 1 \\
\hline
\hyperref[testGetMedAssociatedByPatient:276]{testGetMedAssociatedByPatient} & 276&100.0\% & 1 \\
\hline
\hyperref[testGetMedByHospital:286]{testGetMedByHospital} & 286&100.0\% & 1 \\
\hline
\hyperref[testGetMedMoreHospitals:263]{testGetMedMoreHospitals} & 263&100.0\% & 1 \\
\hline
\hline
SafetyNetHospitalTest.vdmpp & & 100.0\% & 56 \\
\hline
\end{longtable}
