...
\hline
\hyperref[main:289]{main} & 289&100.0\% & 2 \\
\hline
\hyperref[testAppointment:173]{testAppointment} & 173&100.0\% & 6 \\
\hline
\hyperref[testGetsSetsTask:63]{testGetsSetsTask} & 63&100.0\% & 2 \\
\hline
\hyperref[testScheduleFunctions:255]{testScheduleFunctions} & 255&100.0\% & 2 \\
\hline
\hyperref[testSurgery:224]{testSurgery} & 224&100.0\% & 3 \\
\hline
\hyperref[testTreatment:247]{testTreatment} & 247&100.0\% & 2 \\
\hline
\hline
TaskTest.vdmpp & & 100.0\% & 731 \\
\hline
\end{longtable}
