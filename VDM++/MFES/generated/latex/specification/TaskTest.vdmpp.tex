...
@*)
  ...
  testScheduleFunctions() == (
   dcl sch : Schedule, sch1 : Schedule, dateNew: Types`Date, dateNew2 : Types`Date;
...
\hline
\hline
\hyperref[assertTrue:59]{assertTrue} & 59&100.0\% & 4136 \\
\hline
\hyperref[main:279]{main} & 279&100.0\% & 18 \\
\hline
\hyperref[testAppointment:170]{testAppointment} & 170&100.0\% & 18 \\
\hline
\hyperref[testGetsSetsTask:63]{testGetsSetsTask} & 63&100.0\% & 18 \\
\hline
\hyperref[testScheduleFunctions:252]{testScheduleFunctions} & 252&100.0\% & 18 \\
\hline
\hyperref[testSurgery:221]{testSurgery} & 221&100.0\% & 18 \\
\hline
\hyperref[testTreatment:244]{testTreatment} & 244&100.0\% & 18 \\
\hline
\hline
TaskTest.vdmpp & & 100.0\% & 4244 \\
\hline
\end{longtable}
