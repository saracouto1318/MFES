...
\hline
\hline
\hyperref[Appointment:11]{Appointment} & 11&100.0\% & 16 \\
\hline
\hyperref[addPrescription:30]{addPrescription} & 30&100.0\% & 16 \\
\hline
\hyperref[getPrescriptions:23]{getPrescriptions} & 23&100.0\% & 48 \\
\hline
\hyperref[getPriority:20]{getPriority} & 20&100.0\% & 12 \\
\hline
\hyperref[removePrescription:35]{removePrescription} & 35&100.0\% & 16 \\
\hline
\hyperref[setPriority:26]{setPriority} & 26&100.0\% & 4 \\
\hline
\hline
Appointment.vdmpp & & 100.0\% & 112 \\
\hline
\end{longtable}
